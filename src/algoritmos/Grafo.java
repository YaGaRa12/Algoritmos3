...
public class Grafo {
    ...
    public int graphTree(Grafo grafo, String name) {
        ...
        if (fc.showSaveDialog(null) == JFileChooser.APPROVE_OPTION) {
            ...
            try (FileWriter fw = new FileWriter(name+".gv");
                ...
                out.println("}");
                out.close();
                JOptionPane.showMessageDialog(null, "El grafo se guardará en: " + name + ".gv", "Grafo Creado", JOptionPane.INFORMATION_MESSAGE);
                return 1;
            } catch (IOException e) {
                JOptionPane.showMessageDialog(null, "El grafo NO se guardó en: " + name + ".gv", "Grafo NO creado", JOptionPane.INFORMATION_MESSAGE);
                return 0;
            }
        } else {
    ...
    public int graphWeightedGraph() {
        ...
        if (fc.showSaveDialog(null) == JFileChooser.APPROVE_OPTION) {
            ...
            out.println("}");
            out.close();
            JOptionPane.showMessageDialog(null, "The graph will be saved in: " + name + ".gv", "Grafo Creado", JOptionPane.INFORMATION_MESSAGE);
            return 1;
            } catch (IOException e) {
                JOptionPane.showMessageDialog(null, "The graph couldn't be saved in: " + name + ".gv", "Grafo NO creado", JOptionPane.INFORMATION_MESSAGE);
                return 0;
            }
        } else {
            JOptionPane.showMessageDialog(null, "The graph was not saved.", "Grafo NO creado", JOptionPane.INFORMATION_MESSAGE);
        }
        return 1;
    }
    ...
    public int graphDijkstra(Grafo grafo, String name, HashMap<Integer, Integer> prev, HashMap<Integer, Double> dist) {
        ...
        if (fc.showSaveDialog(null) == JFileChooser.APPROVE_OPTION) {
            ...
            JOptionPane.showMessageDialog(null, "The calculated graph was not saved.", "Grafo NO creado", JOptionPane.INFORMATION_MESSAGE);
        }
        return 1;
    }
